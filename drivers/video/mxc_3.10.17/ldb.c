...
static struct fb_videomode ldb_modedb[] = {
	{
/* AUO:  A056VN01 V1
 *      CLK=35714, HSwidth=10(1-255), VSwidth=2(1-255) 
 *      HBackPorch 70(40-255), HFrontPorch 80(8-255)
 *      VBackPorch 13(6-128),  VFrontPorch 30(4-255) 
 * Evervision VGG644805-6UFLWD
 *      CLK=39722(25.175 MHz), HSwidth=30(5-??), VSwidth=3(1-5) 
 *      HS Period 800, VS Period 525
 */ 
	 "LDB-VGA", 60, 640, 480, 37000,  // 25.175 MHz 
	 80, 80,				// left & right margin
	 25, 35,				// upper & lower margin
	 30,  2,					// hsync & vsync length
	 0,						// sync
	 FB_VMODE_NONINTERLACED,
	 FB_MODE_IS_DETAILED,},
	{
	 "LDB-WVGA", 60, 800, 480, 33898,  // kws 
	 192, 40,			   // needs adjustment
	 21, 7,
	 60, 10,
	 0,
	 FB_VMODE_NONINTERLACED,
	 FB_MODE_IS_DETAILED,},
	{
	 "LDB-XGA600", 60, 1024, 600, 15385,   /* maxle: org=768 statt 600 */
	 220, 40,
	 21, 7,
	 60, 10,
	 0,
