...
// wiwi kws added, don't forget to add "debug" to cmdline
#define DEBUG
...
// wiwi:added xga, sxga etc.  present in 3.0.35 but removed here...
...
static void mxc_hdmi_edid_rebuild_modelist(struct mxc_hdmi *hdmi)
{
	...
	//wiwi: change default mode from 640x480 to 1280x1024. It works for me.
...
//===============================================================
        printk("WARNING: simulating edid read error!\n");
        edid_status = HDMI_EDID_NO_MODES; /* wiwi test workaround */
//===============================================================
